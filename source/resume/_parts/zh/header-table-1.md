...
<tbody>
    ...
    <tr>
      <td><a href="#resume-android" class="resume-link" target="_blank">安卓</a></td>
      <td><a href="#resume-ios" class="resume-link" target="_blank">IOS</a></td>
      <td><a href="#resume-hm" class="resume-link" target="_blank">鸿蒙</a></td>
      <td><a href="#resume-flutter" class="resume-link" target="_blank">Flutter</a></td>
      <td><a href="#resume-rn" class="resume-link" target="_blank">RN</a></td>
      <td><a href="#resume-kmp" class="resume-link" target="_blank">KMP</a></td>
      <td><a href="#resume-xcx" class="resume-link" target="_blank">小程序</a></td>
      ...
      <td><a href="#resume-inex" class="resume-link" target="_blank">完整版</a></td>
    </tr>
</tbody>
</table>
