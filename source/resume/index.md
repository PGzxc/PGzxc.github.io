...
- 驻场办公，负责日立中国-研发中心-养老项目组的定制化研发工作
...
项目描述：脑训练是日立养老产品日本养老项目的本地化产品。包含有反应力、专注力、记忆力等分类的60秒小游戏，游戏前通过佩戴脑设备XB-01，游戏时通过蓝牙传输将脑血流的结果借助颜色变化反映到游戏界面上，并展示相关音效(鼓励、加油等)。并根据训练结果进行针对性推荐训练。    
...
__4-前端项目—小游戏__   
项目描述：前端小游戏是脑训练、脑检测中的游戏项目，是基于P5.js制作的小游戏和收集整理GitHub上开源游戏项目而来，配合XB-01设备测量在不同游戏环境下用户的脑血量反应，用于和安卓原生项目和小程序项目进行交互和数据传输。并适配了平板和小程序页面。   
...
__5-微信小程序—日立健康__   
项目描述：日立健康小程序是日立养老项目组将现有的项目(步态+脑训练+睡眠健康等)进行部分整合后开发的一款微信小程序，在不安装app的情况下，通过小程序实现部分需要app和硬件需要完成的功能。   
...
## <font color=red>3. 2015/10 — 2016/07&emsp;时间者互联网科技(北京)有限公司&emsp; Android开发工程师</font> 
### 公司简介
...
## <font color=red>2. 2014/10 — 2015/10&emsp;乐易考（北京）教育科技有限公司&emsp; Android开发工程师</font> 
### 公司简介
...
## <font color=red>1. 2013/06 — 2014/07&emsp;广达上海制造城&emsp;测试助理工程师</font> 
### 公司简介
